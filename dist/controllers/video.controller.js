...
exports.deleteVideo = exports.getVideoById = exports.commentsVideos = exports.likeVideos = exports.getVideos = exports.uploadVideos = void 0;
var prisma_1 = require("../utils/prisma");
var uploadVideos = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, title, description, videoUrl, thumbnail, newVideo, error_1;
    var _b, _c, _d, _e;
    return __generator(this, function (_f) {
        switch (_f.label) {
            case 0:
                ...
                videoUrl = (_c = (_b = req.file) === null || _b === void 0 ? void 0 : _b.path) !== null && _c !== void 0 ? _c : "";
                thumbnail = videoUrl
            ...
            case 2:
                error_1 = _f.sent();
                console.error("Video upload error:", error_1);
...
var getVideos = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, _b, page, _c, limit, skip, videos, error_2;
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                ...
                return [4 /*yield*/, prisma_1.prisma.video.findMany({
                        skip: skip,
                        take: Number(limit),
            ...
            case 2:
                error_2 = _d.sent();
                console.error("Video fetch error:", error_2);
                res.status(500).json({ error: error_2.message || "Failed to fetch videos" });
                return [3 /*break*/, 3];
            case 3: return [2 /*return*/];
        }
    });
...
var likeVideos = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_g) {
        switch (_g.label) {
            ...
            case 6:
                error_3 = _g.sent();
                console.error("Video like error:", error_3);
...
var commentsVideos = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var error_4;
    var _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 2:
                error_4 = _c.sent();
                console.error("Video Comment error:", error_4);
...
exports.commentsVideos = commentsVideos;
var getVideoById = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, prisma_1.prisma.video.findUnique({
            ...
            case 2:
                error_5 = _a.sent();
                console.error("Video Fetched error:", error_5);
                res.status(500).json({ error: error_5.message || "video failed" });
                return [3 /*break*/, 3];
            case 3: return [2 /*return*/];
        }
    });
        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, prisma_1.prisma.$transaction([
                        prisma_1.prisma.comment.deleteMany({ where: { videoId: videoId } }),
                        prisma_1.prisma.like.deleteMany({ where: { videoId: videoId } }),
                        prisma_1.prisma.video.delete({ where: { id: videoId } })
                    ])];
            case 2:
                _a.sent();
                return [2 /*return*/, res
            ...
            case 3:
                ...
                return [2 /*return*/, res.status(500).json({ error: "Failed to delete video" })];
