...
router.post("/upload-video", authMiddleware_1.authMiddleware, upload_1.uploadVideo.single("video"), video_controller_1.uploadVideos);
router.get("/", authMiddleware_1.authMiddleware, video_controller_1.getVideos);
router.get("/like/:id", authMiddleware_1.authMiddleware, video_controller_1.likeVideos);
router.post("/comments/:id", authMiddleware_1.authMiddleware, video_controller_1.commentsVideos);
router.get("/:id", authMiddleware_1.authMiddleware, video_controller_1.getVideoById);
router.delete("/:videoId", authMiddleware_1.authMiddleware, video_controller_1.deleteVideo);
